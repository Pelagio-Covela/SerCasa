    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white text-blue-600 rounded-full flex items-center justify-center font-bold">1</div>
                <div>
              ...
              <div className="flex items-center gap-3 opacity-60">
                ...
                <div>
                  ...
                  <div className="text-sm text-blue-100">Quando precisa</div>
                </div>
              </div>
              <div className="flex items-center gap-3 opacity-60">
                ...
                <div>
                  ...
                  <div className="text-sm text-blue-100">Veja os disponíveis</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Por que contratar pela ServCasa?</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Todos passam por verificação rigorosa de antecedentes e qualificações</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Escolha o melhor dia e horário para si</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Veja em tempo real os profissionais disponíveis para o seu horário</p>
              </div>
            </div>
          </div>
        </div>
