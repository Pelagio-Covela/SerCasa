...
import { getProfissional } from "../api";
...
export function DetalheProfissional() {
  ...
  const totalServico = profissional.precoPorHora * parseInt(duracao || "0", 10);
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Competências</h2>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                {[
                  { nome: "João Pedro", avaliacao: 5, data: "Há 2 dias", comentario: "Excelente profissional. Muito pontual e cuidadoso com o trabalho." },
                  { nome: "Mariana Silva", avaliacao: 5, data: "Há 1 semana", comentario: "Recomendo. Trabalho impecável e preço justo." },
                  { nome: "Carlos Eduardo", avaliacao: 4, data: "Há 2 semanas", comentario: "Bom serviço, resolveu o problema rapidamente." },
                ].map((avaliacao, indice) => (
                  <div key={indice} className="border-b border-gray-200 pb-4 last:border-0">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-semibold text-gray-900">{avaliacao.nome}</span>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl shadow-md p-6 border-2 border-green-200">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-gray-900">{hora} - {duracao}h de duração</div>
                  </div>
                  {endereco && (
                    <div>
                  ...
                  <div className="pt-3 border-t border-green-200">
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="font-semibold text-gray-900">{totalServico.toFixed(2)} MT</span>
                    </div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-sm text-gray-600">Taxa de serviço (10%)</span>
                      <span className="font-semibold text-gray-900">{taxaServico.toFixed(2)} MT</span>
                    </div>
                    <div className="flex justify-between items-center pt-2 border-t border-green-200">
                      <span className="text-base font-semibold text-gray-900">Total</span>
                      <span className="text-2xl font-bold text-green-600">{precoFinal.toFixed(2)} MT</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-md p-6 border border-blue-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-gray-700">
                  ...
                  <span className="text-sm">contacto@exemplo.com</span>
                </div>
              </div>
            </div>
          </div>
