...
import { profissionais, categorias } from "../data/profissionais";
...
export function ProfissionaisDisponiveis() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Cabeçalho com informações seleccionadas */}
      ...
      <div className="max-w-7xl mx-auto px-4 pb-12">
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-blue-100 mb-4">
            Entre em contacto connosco e ajudaremos a encontrar o profissional ideal para si
          </p>
